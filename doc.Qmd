...
|  **Terzo Modello senza 37, 28, 11**  | **85.15%** | **525.99** |       Il miglior modello in termini di entrambe le metriche, suggerendo che la rimozione di queste tre variabili produce un modello molto efficace.        |

### Conclusione

Considerando entrambe le metriche, il **Terzo Modello senza 37, 28, 11** sembra essere il migliore. Questo modello presenta il più alto R^2^ Adjusted (85.15%) e il più basso AIC (525.99), indicando un eccellente equilibrio tra capacità di spiegazione della variabilità dei dati e complessità del modello.
