...
Le variabili all'interno del dataset proposto sono 16, tutte di tipo quantitativo:
...
In generale, una combinazione di entrambi i criteri è spesso considerata. Se si desidera un equilibrio tra un buon $R^2$ aggiustato e un basso AIC, si potrebbe considerare il Terzo Modello, che ha un buon $R^2$ aggiustato (80.65%) e un AIC relativamente basso (562.33).
