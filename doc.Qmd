...
-   Se l'obiettivo è massimizzare la capacità del modello di spiegare la variabilità dei dati, il Terzo Modello è il migliore.
...
Se si desidera un equilibrio tra un buon $R^2$ aggiustato e un basso AIC che però è stato soggetto ad una scrematura dei dati, si potrebbe considerare il Terzo Modello, che ha un buon $R^2$ aggiustato (85.15%) e un AIC relativamente basso (525.99).
